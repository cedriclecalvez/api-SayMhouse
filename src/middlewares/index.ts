...
// const corsOptions = {origin:"*",credentials:true,exposedHeaders: 'Authorization'};
const corsOptions = {origin:'http://localhost:3000',credentials:true,exposedHeaders: 'Authorization'};
